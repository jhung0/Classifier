...
// Train the model.
export function logreg_train(X, y, num_features, num_outputs, batch_size, learning_rate, num_epochs) {
  const returnCost = true;

  weights = tf.variable(tf.randomNormal([num_features, 1], 0, 1 / Math.sqrt(num_features)));
